...
final class CsrfMiddlewareTest extends TestCase
{
    ...
    public function test_logout_can_close_a_stale_browser_session():void{$request=new Request('POST','/logout',[],[],[],[]);$response=(new CsrfMiddleware())->handle($request,fn()=>Response::redirect('/login'));self::assertSame(302,$response->statusCode());self::assertSame('/login',$response->headers()['Location']);}
}
