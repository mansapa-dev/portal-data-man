...
foreach($migrations as$file){$sql=file_get_contents($file);if($sql===false)throw new RuntimeException("Migration {$file} tidak dapat dibaca.");$db->exec($sql);fwrite(STDOUT,'Migration '.basename($file)." diterapkan.\n");}
