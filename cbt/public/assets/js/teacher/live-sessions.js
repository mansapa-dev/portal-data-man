(function () {
  ...
  function filterBar(payload, refreshView, fields = null) {
  ...
  function render(root, payload, refresh, options = {}) {
    ...
    if(options.enableFilters)root.append(heading,filterBar(payload,()=>render(root,payload,refresh,options),options.filterFields));else root.append(heading);
