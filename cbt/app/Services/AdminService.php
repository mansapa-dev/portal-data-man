...
final class AdminService
{
 ...
 public function adminLiveSessions():array{return$this->liveSessionPayload($this->repo->teacherExamIds(0,true));}
 ...
 public function teacherLiveSessions(int$userId):array{return$this->liveSessionPayload($this->repo->teacherExamIds($userId,false));}
