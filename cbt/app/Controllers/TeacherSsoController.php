...
final class TeacherSsoController
{
    ...
    public function logout(Request $request): Response { Session::destroy();$oidc=$this->oidc();$endSession=$oidc['end_session_endpoint']??(rtrim((string)Config::get('PORTAL_DATA_OIDC_ISSUER',''),'/').'/logout');header('Location: '.$endSession);exit; }
