...
final class SyncController
{
 ...
 public function run(Request$r):Response{try{return Response::json($this->sync->sync(strtoupper((string)$r->attributes['type']),(int)$_SESSION['auth']['user_id']),'Sinkronisasi selesai.');}catch(\Throwable$e){throw new DomainException($e->getMessage(),502);}}
