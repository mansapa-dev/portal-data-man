...
- Sisa waktu dihitung dari saat pelanggaran terakhir dan mulai berjalan lagi saat admin melakukan reset. Jadwal boleh belum aktif, nonaktif, atau sudah berakhir; siswa tetap harus aktif. Reset tidak memberikan durasi ujian baru. Attempt yang sudah dibuka dapat dilanjutkan dari dashboard sampai sisa waktunya habis, sedangkan siswa tanpa attempt tetap mengikuti batas jadwal. Proses penilaian otomatis yang terlambat tidak boleh menutup kembali attempt yang sudah direset.
...
- Tes tambahan: 23 pemeriksaan bawaan CBT, 7 skenario antrean jawaban, 2 skenario dashboard, 66 pemeriksaan integrasi database, dan 7 tes Laravel Portal Data (28 assertion). Pengujian browser visual, data/gambar produksi, gangguan jaringan sekolah, dan service Portal/SSO langsung belum dilakukan.
