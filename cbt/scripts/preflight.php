...
foreach(['APP_URL','APP_KEY','DB_HOST','DB_DATABASE','DB_USERNAME','PORTAL_DATA_BASE_URL','PORTAL_DATA_API_KEY']as$key)$check((string)Config::get($key)!=='',"Environment {$key}");
$check(strlen((string)Config::get('APP_KEY'))>=32,'APP_KEY minimal 32 karakter');
$check(strlen((string)Config::get('PORTAL_DATA_API_KEY'))>=32,'PORTAL_DATA_API_KEY minimal 32 karakter');
